...
When Trust_in_Scientists increases by 1 unit, holding all other predictors in the model constant, the multiplicative increase in odds of someone saying they will get the vaccine is 1.78.
...
```{r 1g 1}
glm.probs <- predict(glm.vaccine, newdata = misinf_test, type = "response")
```
...
vaccine_pred <- data.frame(predicted = glm.pred, actual = misinf_test$Vaccine)
conf_mat(vaccine_pred, truth = actual, estimate = predicted)
```
