...
```{r test power-return 1, eval = FALSE}
...
```{r test power-return 2, eval = FALSE}
result1 <- Power(2, 3)
...
```{r power-default test-1, eval = FALSE}
Power_default(2, 3)
```
